export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'ThanhPhuong MERN Stack Board',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover:
              'https://avatars.githubusercontent.com/u/99084016?s=400&u=c3f9fa59deca6877371fa38f62311303a0757fa7&v=4',
      ...
      },
      {
        ...
        /** Card đặc biệt sẽ bị ẩn ở giao diện UI người dùng
         * Quan trọng khi tạo phải đầy đủ: _id, boardId, columnId, FE_PlaceholderCard
         * Mỗi column chỉ có thể có tối đa một Placeholder Card
         */
