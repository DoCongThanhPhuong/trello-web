...
import { listUserBoardsAPI } from '~/apis'
...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    // Gọi API để fetch danh sách board với searchValue và gọi hàm handleBoardsFetchSuccess
    listUserBoardsAPI(searchPath)
      .then((res) => {
  ...
  const debounceSearchBoards = useDebounceFn(handleInputSearchChange, 500)
